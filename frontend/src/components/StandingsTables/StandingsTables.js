...
// import { useLeagueContext } from "../LeagueContext";
// import { getUserById } from "../../Apis/auth";
// import { getGamesPlayedByDateRange } from "../../Apis/predictions"; // Import the new API call
// import { headerOptions } from "./data"; // Import headerOptions
...
// const StandingsTables = ({ startDate, endDate }) => {
//   const { selectedLeague } = useLeagueContext();
//   const [filteredHeaderOptions, setFilteredHeaderOptions] = useState([]);
//   const [weeklyGames, setWeeklyGames] = useState([]); // State to hold weekly data
//   const id = localStorage.getItem("_id");
...
//     // API call to fetch games data by date range
//     getGamesPlayedByDateRange(startDate, endDate)
//       .then((res) => {
//         console.log("Games data:", res);
//         if (res.data && Array.isArray(res.data.games)) {
//           setWeeklyGames(res.data.games); // Set games data
//         } else {
//           console.error("Expected array but got:", res);
//         }
//       })
...
//       getWeeklyGames();
//     });
//   }, [selectedLeague, startDate, endDate]);
...
//   const { tpValues, ranks } = calculateTPandRank(weeklyGames);
...
//         </thead>
//         <tbody>
//           {Array.isArray(weeklyGames) && weeklyGames.length > 0 ? (
//             weeklyGames.map((row, index) => {
//               return (
//                 <tr key={index} className="h-14 bg-[#181818] text-white separator">
//                   <td className="text-xs font-medium text-center">{row.co || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.state || "-"} / {row.country || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.favorite || "-"}</td>
//                   <td className="text-xs font-medium text-center">{ranks[index]}</td>
//                   <td className="text-xs font-medium text-center">{row.players || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.wpt || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.gp || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.BR || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.wins || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.losses || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.cleanSheets || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.winningStreak || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.losingStreak || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p1s || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p1s0 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p2s0 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p1s2p || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p2s2p || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p1s3 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p2s3 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p1s7 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.p2s7 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.moneyLine || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.spread || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.overUnder || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.APN || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.APG || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.F || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.U || "-"}</td>
//                   <td className="text-xs font-medium text-center">{calculateReg(row) || "0"}</td>
//                   <td className="text-xs font-medium text-center">{calculateEI(row) || "0"}</td>
//                   <td className="text-xs font-medium text-center">{calculateOT(row) || "-"}</td>
//                   <td className="text-xs font-medium text-center">{calculateSO(row) || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.l10 || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.fpts || "-"}</td>
//                   <td className="text-xs font-medium text-center">{row.upts || "-"}</td>
//                 </tr>
//               );
//             })
//           ) : (
//             <tr>
//               <td colSpan="36" className="text-center text-white">No data available</td>
//             </tr>
//           )}
//         </tbody>
//       </table>
