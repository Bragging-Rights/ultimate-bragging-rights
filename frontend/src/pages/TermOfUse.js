  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 text-white">
      <h1 className="text-3xl font-bold mb-4">
        SPORTS FANS I.Q. CHALLENGES INC. Terms of Service
      </h1>
      <p>
        These Terms of Service govern your use of the website located at{" "}
        <a
          href="https://www.ultimatebraggingrights.com"
          className="text-blue-500"
        >
          https://www.ultimatebraggingrights.com
        </a>{" "}
        and any related services provided by SPORTS FANS I.Q. CHALLENGES INC..
      </p>
      <p>
        By accessing{" "}
        <a
        ...
        using any other services provided by SPORTS FANS I.Q. CHALLENGES INC..
      </p>
      <p>
        We, SPORTS FANS I.Q. CHALLENGES INC., reserve the right to review and
      ...
      <p>These Terms of Service were last updated on March 28, 2024.</p>

      <h2 className="text-2xl font-bold mt-8 mb-4">Limitations of Use</h2>
      <p>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>
          ...
          service SPORTS FANS I.Q. CHALLENGES INC. provides;
        </li>
        <li>
      ...
      <p>
        ...
        owned by or licensed to SPORTS FANS I.Q. CHALLENGES INC. and are
      ...
      <p>
        ...
        restrictions or the Terms of Service, and may be terminated by SPORTS
        FANS I.Q. CHALLENGES INC. at any time.
      </p>
      ...
      <p>
        ...
        basis. To the extent permitted by law, SPORTS FANS I.Q. CHALLENGES INC.
      ...
      <p>
        In no event shall SPORTS FANS I.Q. CHALLENGES INC. or its suppliers be
        ...
        materials on this website, even if SPORTS FANS I.Q. CHALLENGES INC. or
      ...
      <p>
        ...
        general information purposes only. SPORTS FANS I.Q. CHALLENGES INC. does
      ...
      <p>
        SPORTS FANS I.Q. CHALLENGES INC. has not reviewed all of the sites
        ...
        approval or control by SPORTS FANS I.Q. CHALLENGES INC. of the site. Use
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">Right to Terminate</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">Severance</h2>
      <p>
