          ...
          <table className="custom-table">
            <thead>
              <tr>
                ...
                <th onClick={() => toggleSortOrder('SW2')} style={{ cursor: 'pointer' }}>1SW7</th>
                <th onClick={() => toggleSortOrder('REG')} style={{ cursor: 'pointer' }}>2SW7</th>
                <th onClick={() => toggleSortOrder('E1')} style={{ cursor: 'pointer' }}>REG</th>
                <th onClick={() => toggleSortOrder('N1')} style={{ cursor: 'pointer' }}>OT</th>
