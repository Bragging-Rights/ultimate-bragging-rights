          ...
          <table className="custom-table">
            <thead>
              <tr>
                ...
                <th onClick={() => toggleSortOrder('shutout')} style={{ cursor: 'pointer' }}>1SW2</th> 
                <th onClick={() => toggleSortOrder('ending')} style={{ cursor: 'pointer' }}>2SW2</th>
                <th onClick={() => toggleSortOrder('SW2')} style={{ cursor: 'pointer' }}>REG</th>
                <th onClick={() => toggleSortOrder('REG')} style={{ cursor: 'pointer' }}>E1</th>
                <th onClick={() => toggleSortOrder('E1')} style={{ cursor: 'pointer' }}>1S0</th>
