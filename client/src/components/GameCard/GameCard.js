   ...
   <>
    ...
    <div className='game-card col-5'>
        <div className=" w-100 d-flex justify-content-between ">
            ...
            <span className=" game-date mb-3">April 4, 2023</span>
            <div className=" box ">Toronto</div>
            </div>
            <div className=" d-flex flex-column ">
                   
                         <span className=" game-time mb-3 ">Money Line</span>
                         <div className=" box">+100 12 Pts</div>
                   </div>
                   <div className=" d-flex flex-column ">
                   
                   <span className=" game-time mb-3">Spread</span>
                   <div className=" box">+1.5 12 Pts</div>
             </div>
             <div className=" d-flex flex-column ">
                   
             <span className=" game-time mb-3">Over/Under</span>
