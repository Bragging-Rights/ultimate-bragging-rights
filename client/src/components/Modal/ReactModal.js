...
>
  ...
  />
       ...
       <ModalInput label={"FIRST NAME"} placeholder={"First Name"}
         name='firstName'
         value={formData.firstName}
         onChange={inputChangeHandler}
       />
       <ModalInput label={"LAST NAME"} placeholder={"Last Name"}
           name='lastName'
           value={formData.lastName}
           onChange={inputChangeHandler}
       />
       <ModalSelect label={"SEX"}
        ...
        onChange={inputChangeHandler}
       />
       <ModalInput label={"CITY"} placeholder={"City"}
          name="city"
          value={formData.city}
          onChange={inputChangeHandler}
       />
      ...
      <ModalInput label={"Postal/ZIP Code"} placeholder={"Postal/ZIP code"}
           type="number"
           name="postalCode"
...
<div className='element-container'> 
    <div>
      ...
      <div className='line'></div>
       ...
       />
       <ModalInput label={"Create Unique Username"} placeholder={"User Name"}
           type="text"
           name="username"
...
>
  ...
  />
      ...
      <ModalInput label={"Create Password"} placeholder={"Create Password"}
         name="password"
         value={formData.password}
         onChange={inputChangeHandler}
      />
      <ModalInput label={"Confirm Password"} placeholder={"Confirm Password"}
        type="password"
      ...
      />
        ...
        <div  className='privacy-policy'>
          ...
          />
          <div>I certify that I am at least 18 years old and that I agree to the Terms of services and Privacy Policy. </div>
        </div>
        </div>
